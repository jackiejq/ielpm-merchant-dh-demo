 ...
 * @author zcc
 */
public class DhDeductPayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(DhDeductPayServlet.class);
	private static final String TAG = "【代还扣款交易】-";
